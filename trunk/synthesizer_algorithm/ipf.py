...
def ipf_config_run (db, synthesis_type, control_variables, dimensions, county, pumano, tract, bg):
...
# Creating objective joint distributions to match the resulting sunthetic populations against
    ...
    adjusting_sample_joint_distribution.adjust_weights(db, synthesis_type, control_variables, county, pumano, tract, bg)
