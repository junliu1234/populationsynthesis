...
DEFAULT_HOUSING_PUMS2000_QUERIES = ["alter table housing_pums add index(serialno)",
                                ...
                                "create table hhld_sample select state, pumano, hhid, serialno, hhldtype, hhldinc, hhldsize, childpresence, hhldfam from housing_pums where hhtype = 1",
                                "create table gq_sample select state, pumano, hhid, serialno, groupquarter from housing_pums where hhtype = 2",
                                "alter table hhld_sample add index(serialno)",
