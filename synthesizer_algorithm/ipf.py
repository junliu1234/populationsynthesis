...
def ipf_config_run (db, synthesis_type, control_variables, varCorrDict, dimensions, county, pumano, tract, bg, parameters):
...
# Creating objective joint distributions to match the resulting sunthetic populations against
    ...
    adjusting_sample_joint_distribution.adjust_weights(db, synthesis_type, control_variables, varCorrDict, county, pumano, tract, bg, parameters)
