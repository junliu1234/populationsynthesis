DEFAULT_PERSON_PUMS_QUERIES = [ "alter table person_pums add column agep text",
                                "alter table person_pums add column gender text",
                                "alter table person_pums add column race text",
                                "alter table person_pums add column employment text",
                                ...
                                "create table person_sample select state, puma5, hhid, serialno, pnum, pweight, agep, gender, race, employment from person_pums"]

DEFAULT_HOUSING_PUMS_QUERIES = ["alter table housing_pums add column hhtype text",
                                "alter table housing_pums add column hhldtype text",
                                "alter table housing_pums add column hhldinc text",
                                "alter table housing_pums add column hhldtenure text",
                                "alter table housing_pums add column hhldsize text",
                                "alter table housing_pums add column childpresence text",
                                "alter table housing_pums add column groupquarter text",
                                ...
                                "create table hhld_sample select state, puma5, hhid, serialno, hhtype, hhldtype, hhldinc, hhldsize, childpresence from housing_pums where hhtype = 1",
                                "create table gq_sample select state, puma5, hhid, serialno, hhtype, groupquarter from housing_pums where hhtype = 2"]

DEFAULT_SF_QUERIES = ["alter table %s add column agep1 text",
                      "alter table %s add column agep2 text",
                      "alter table %s add column agep3 text",
                      "alter table %s add column agep4 text",
                      "alter table %s add column agep5 text",
                      "alter table %s add column agep6 text",
                      "alter table %s add column agep7 text",
                      "alter table %s add column agep8 text",
                      "alter table %s add column agep9 text",
                      "alter table %s add column agep10 text",
                      "alter table %s add column gender1 text",
                      "alter table %s add column gender2 text",
                      "alter table %s add column race1 text",
                      "alter table %s add column race2 text",
                      "alter table %s add column race3 text",
                      "alter table %s add column race4 text",
                      "alter table %s add column race5 text",
                      "alter table %s add column race6 text",
                      "alter table %s add column race7 text",
                      "alter table %s add column employment1 text",
                      "alter table %s add column employment2 text",
                      "alter table %s add column employment3 text",
                      "alter table %s add column employment4 text",
                      "alter table %s add column childpresence1 text",
                      "alter table %s add column childpresence2 text",
                      "alter table %s add column groupquarter1 text",
                      "alter table %s add column groupquarter2 text",
                      "alter table %s add column hhldinc1 text",
                      "alter table %s add column hhldinc2 text",
                      "alter table %s add column hhldinc3 text",
                      "alter table %s add column hhldinc4 text",
                      "alter table %s add column hhldinc5 text",
                      "alter table %s add column hhldinc6 text",
                      "alter table %s add column hhldinc7 text",
                      "alter table %s add column hhldinc8 text",
                      "alter table %s add column hhldsize1 text",
                      "alter table %s add column hhldsize2 text",
                      "alter table %s add column hhldsize3 text",
                      "alter table %s add column hhldsize4 text",
                      "alter table %s add column hhldsize5 text",
                      "alter table %s add column hhldsize6 text",
                      "alter table %s add column hhldsize7 text",
                      "alter table %s add column hhldtype1 text",
                      "alter table %s add column hhldtype2 text",
                      "alter table %s add column hhldtype3 text",
                      "alter table %s add column hhldtype4 text",
                      "alter table %s add column hhldtype5 text",
